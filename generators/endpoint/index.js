...
module.exports = class extends BaseGenerator {
    ...
    _generateAppCode(configOptions) {
        const mainJavaTemplates = [
            ...
            {src: 'web/controller/Controller.java', dest: 'controller/'+configOptions.entityName+'Controller.java'},
        ];
        this.generateMainJavaCode(configOptions, mainJavaTemplates);

        const testJavaTemplates = [
            {src: 'web/controller/ControllerTest.java', dest: 'controller/'+configOptions.entityName+'ControllerTest.java'},
            {src: 'web/controller/ControllerIT.java', dest: 'controller/'+configOptions.entityName+'ControllerIT.java'},
        ];
