...
module.exports = class extends Generator {
    ...
    generateEntityfile(configOptions) {
        this.fs.copyTpl( 
            this.templatePath('app/src/main/java/entity/Entity.java'),
            //this.destinationPath('src/main/java/entity/'+configOptions.entityName+'.java'),
            this.destinationPath('src/main/java/'+configOptions.packageFolder+'/entity/'+configOptions.entityName+'.java'),
            configOptions
        );
    }
    generateControllerfile(configOptions) {
        this.fs.copyTpl(
            this.templatePath('app/src/main/java/controller/Controller.java'),
            this.destinationPath('src/main/java/'+configOptions.packageFolder+'/controller/'+configOptions.appName+'Controller.java'),
            configOptions
        );
    }
    generateServicefile(configOptions) {
        this.fs.copyTpl(
            this.templatePath('app/src/main/java/service/Service.java'),
            this.destinationPath('src/main/java/'+configOptions.packageFolder+'/service/'+configOptions.appName+'Service.java'),
            configOptions
        );
    }
    generateRepositoryfile(configOptions) {
        this.fs.copyTpl(
            this.templatePath('app/src/main/java/repository/Repository.java'),
            this.destinationPath('src/main/java/'+configOptions.packageFolder+'/repository/'+configOptions.entityName+'Repository.java'),
            configOptions
        );
    }
